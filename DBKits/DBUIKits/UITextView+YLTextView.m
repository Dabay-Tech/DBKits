...
//    
//    // 这一行是我自己加的
//    self.wordCountLabel.text = [NSString stringWithFormat:@"%i/%@",0,self.limitLength];
//    
//}
//
...
//    self.placeholderLabel.textColor = SetColor(@"999999");
...
//    self.placeholderLabel.frame = CGRectMake(7, 7, SCREEN_WIDTH - 40, 30);
...
//    
////    self.wordCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 95, self.frame.size.height - 20, 60, 20)];
//    
//    self.wordCountLabel.textAlignment = NSTextAlignmentRight;
//    self.wordCountLabel.textColor = SetColor(@"333333");
